...
check('J', migs.every((f) => f.startsWith('0049') || f.startsWith('0050') || f.startsWith('0051') || f.startsWith('0052')), 'ZERO migration na Fase 12.2 (Módulo 18); acima da 0048 só existem 0049/0050 (Copiloto — Fase 16) e 0051 (Localização — Fase 20)');
