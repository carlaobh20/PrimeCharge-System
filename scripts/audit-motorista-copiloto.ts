...
check('G', migs.every((f) => f.startsWith('0049') || f.startsWith('0050') || f.startsWith('0051') || f.startsWith('0052')), 'acima da 0048 só existem 0049, 0050 e 0051 (Fase 16/20 — sem migration de assinatura ainda)');
