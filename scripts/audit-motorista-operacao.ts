...
check('K', migs.every((f) => f.startsWith('0048') || f.startsWith('0049') || f.startsWith('0050')), 'ZERO migration da Fase 10 (acima da 0047: 0048 diário, 0049/0050 Copiloto — Fase 16)');
