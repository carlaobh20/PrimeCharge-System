// Ponto único de acesso público desta pasta para fora do módulo Contratos — mesmo padrão de
// features/frota/intelligence/index.ts e features/motoristas/intelligence/index.ts
// (DEC-024/DEC-025): agregadores (Command Center) importam as funções puras de cálculo
// através de um barril como este, nunca direto de dentro da pasta.
