...
// Painel específico do Cockpit do Contrato: título, ícone e layout são do módulo — o item de
// verdade (InsightCard) é o pedaço reutilizável (mesmo padrão de frota/motoristas, DEC-023).
