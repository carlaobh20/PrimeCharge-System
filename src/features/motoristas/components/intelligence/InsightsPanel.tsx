...
// Painel específico do Cockpit do Motorista: título, ícone e layout são do módulo — o item
// de verdade (InsightCard) é o pedaço reutilizável (mesmo padrão de frota/, ver DEC-023).
